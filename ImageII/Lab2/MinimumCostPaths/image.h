...
class image{
 ...
 public:
  ...
  T& operator[](int i){
   ...
   void get_4_neighbors(int x, int y, vector<int>& n){
    n.clear();
    if(valid(x+1,y)){
  ...
  void get_4_neighbors(int i, vector<int>& n){
    get_4_neighbors(index2x(i), index2y(i),n);
  }
  
   void get_8_neighbors(int x, int y, vector<int>& n){
    n.clear();
	if(valid(x+1,y)){
      n.push_back(xy2index(x+1,y));
    }
  ...
  void get_8_neighbors(int i, vector<int>& n){
    get_8_neighbors(index2x(i), index2y(i),n);
